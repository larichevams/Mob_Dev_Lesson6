package ru.mirea.laricheva.notebook;
...
import ru.mirea.laricheva.notebook.databinding.ActivityMainBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else {  Log.w("ExternalStorage", "is unwritable"); }
            }
        });
        ...
        binding.loadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else { Log.w("ExternalStorage", "is unreadable"); }
            }
        });
